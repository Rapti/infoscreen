...
//    window = new sf::RenderWindow(sf::VideoMode(800, 600), "Test");
    ...
    g = new Grid(60, 60);
    t = new ThemeDefault();
    t = new ThemeMovingShapes(ShapeTheme::THEME_4, "", 17, 22, 24);
...
//    g->addModule(new ModuleDatausage(), 12, 43, 48, 7);
    ...
    g->addModule(new ModuleOctoprint("192.168.178.75:5000/api", "1327FC722BD44208BCEFFACDE8A118A8"), 36, 43, 24, 7);
